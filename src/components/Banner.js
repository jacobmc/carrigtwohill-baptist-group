...
export default function Banner() {
	...
	const BackgroundGradient = styled.div`
		background: linear-gradient(93.88deg, #000000 0%, rgba(42, 42, 42, 0.834768) 48.27%, rgba(67, 67, 67, 0.736985) 66.49%, rgba(126, 126, 126, 0.506307) 86.4%, rgba(255, 255, 255, 0) 100%);
	`;
